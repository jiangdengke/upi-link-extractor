...
from .user_agent_profile import (
    WINDOWS_USER_AGENT as USER_AGENT,
    CHROME_MAJOR,
    CHROME_FULL as CHROME_FULL_VERSION,
    SEC_CH_UA,
    SEC_CH_UA_PLATFORM,
    ...
    DEVICE_MEMORY_GB as DEVICE_MEMORY,
)

SEC_CH_UA_FULL_VERSION_LIST = (
    f'"Google Chrome";v="{CHROME_FULL_VERSION}", '
    f'"Chromium";v="{CHROME_FULL_VERSION}", "Not_A Brand";v="24.0.0.0"'
)
SEC_CH_UA_ARCH = '"x86"'
